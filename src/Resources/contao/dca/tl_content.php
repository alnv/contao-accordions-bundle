...
$GLOBALS['TL_DCA']['tl_content']['fields']['mooHeadline']['default'] = 'span';
...
$GLOBALS['TL_DCA']['tl_content']['fields']['mooHeadline']['options'] = ['span', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6'];
...
$GLOBALS['TL_DCA']['tl_content']['fields']['isFAQMarkup'] = [
    'label' => ['Diesen Inhalt mit schema.org als FAQ auszeichnen', ''],
    'inputType' => 'checkbox',
    'eval' => [
        'tl_class' => 'm12 w50'
    ],
